...
# Base model location
# MODEL_PATH = os.environ.get('MODEL_PATH', '/root/dataDisk/hf/chatglm3-6b')
# Finetuned model location
MODEL_PATH = os.environ.get('MODEL_PATH', '/root/dataDisk/chatglm/finetune_demo/output/checkpoint-3000')
